package mhandharbeni.com.voicetime.stopwatch;
...
import mhandharbeni.com.voicetime.chronometer.ChronometerDelegate;
import mhandharbeni.com.voicetime.chronometer.ChronometerNotificationService;
import mhandharbeni.com.voicetime.stopwatch.data.AsyncLapsTableUpdateHandler;
import mhandharbeni.com.voicetime.stopwatch.ui.StopwatchFragment;
...
public class StopwatchNotificationService extends ChronometerNotificationService {
    ...
    public static final String ACTION_ADD_LAP = "mhandharbeni.com.voicetime.stopwatch.action.ADD_LAP";
    public static final String ACTION_UPDATE_LAP_TITLE = "mhandharbeni.com.voicetime.stopwatch.action.UPDATE_LAP_TITLE";

    public static final String EXTRA_LAP_NUMBER = "mhandharbeni.com.voicetime.stopwatch.extra.LAP_NUMBER";
    ...
    protected PendingIntent getContentIntent() {
        return ContentIntentUtils.create(this, SettingActivity.PAGE_STOPWATCH, -1);
    }
