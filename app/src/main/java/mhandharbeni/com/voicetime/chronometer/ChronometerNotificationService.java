package mhandharbeni.com.voicetime.chronometer;
...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "mhandharbeni.com.voicetime.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "mhandharbeni.com.voicetime.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "mhandharbeni.com.voicetime.extra.ID";
