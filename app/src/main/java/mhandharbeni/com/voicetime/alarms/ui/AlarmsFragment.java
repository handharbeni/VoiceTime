...
import mhandharbeni.com.voicetime.alarms.data.AlarmsListCursorLoader;
...
import mhandharbeni.com.voicetime.dialogs.TimePickerDialogController;
import mhandharbeni.com.voicetime.list.RecyclerViewFragment;
import mhandharbeni.com.voicetime.util.DelayedSnackbarHandler;

import static mhandharbeni.com.voicetime.util.FragmentTagUtils.makeTag;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "mhandharbeni.com.voicetime.alarms.extra.SCROLL_TO_ALARM_ID";
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mSnackbarAnchor = getActivity().findViewById(R.id.maincontent);
