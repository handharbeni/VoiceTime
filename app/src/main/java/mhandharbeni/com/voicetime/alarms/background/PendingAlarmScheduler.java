...
import static mhandharbeni.com.voicetime.util.Preconditions.checkNotNull;
...
public class PendingAlarmScheduler extends BroadcastReceiver {
    ...
    public static final String EXTRA_ALARM_ID = "mhandharbeni.com.voicetime.alarms.background.PendingAlarmScheduler.extra.ALARM_ID";
