...
import mhandharbeni.com.voicetime.alarms.misc.DaysOfWeek;
import mhandharbeni.com.voicetime.dialogs.RingtonePickerDialog;
import mhandharbeni.com.voicetime.dialogs.RingtonePickerDialogController;
import mhandharbeni.com.voicetime.list.OnListItemInteractionListener;
import mhandharbeni.com.voicetime.timepickers.Utils;
import mhandharbeni.com.voicetime.util.FragmentTagUtils;
...
//        // The result will be delivered to SettingActivity, and then delegated to AlarmsFragment.
//        ((Activity) getContext()).startActivityForResult(intent, AlarmsFragment.REQUEST_PICK_RINGTONE);
    ...
    private void bindRingtone() {
        ...
        Drawable ringtoneIcon = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ringtoneIcon = mRingtone.getCompoundDrawablesRelative()[0/*start*/];
        }
